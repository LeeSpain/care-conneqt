...
import { ArrowLeft, HeartPulse, Upload, Trash2 } from 'lucide-react';
...
export default function InekeSettings() {
  ...
  if (loading) {
    return (
      <AdminDashboardLayout title="Ineke Settings">
  ...
  return (
    <AdminDashboardLayout title="Ineke Configuration">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold">Ineke Configuration</h1>
                <p className="text-muted-foreground">Nurse Support AI Assistant</p>
              </div>
            </div>
          </div>
        ...
        <Tabs defaultValue="general" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                  ...
                  <div className="flex-1 space-y-3">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Upload a profile picture for Ineke (max 2MB, JPG/PNG/WebP)
                      </p>
                    </div>
                ...
                <div className="pt-4 border-t">
                  <h4 className="font-semibold mb-2">Nurse-Specific Settings</h4>
                  <p className="text-sm text-muted-foreground">
                    Ineke has access to member data, health metrics, tasks, and alerts within the nurse dashboard.
                    All access is logged and restricted to assigned members only.
                  </p>
                </div>
          ...
          <TabsContent value="prompt">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Define how Ineke behaves and responds to nurses</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    This defines Ineke's medical knowledge, professional tone, and nurse support capabilities.
                  </p>
                </div>
          ...
          <TabsContent value="personality">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Fine-tune Ineke's behavior and responses</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                ...
                <div>
                  <Label htmlFor="temperature">
                    Temperature: {agent.config.temperature}
                    <span className="text-xs text-muted-foreground ml-2">(Lower = more precise for medical)</span>
                  </Label>
                  <Input
                    id="temperature"
                    type="range"
          ...
          <TabsContent value="knowledge">
            <KnowledgeBaseManager agentId={agent.id} agentType="nurse_support" />
          </TabsContent>
